...
class actor(abstract_agent):
    ...
    def reset_parameters(self):
        nn.init.xavier_uniform(self.linear_a1.weight, gain=nn.init.calculate_gain('leak_relu')) # 均匀分布
        nn.init.xavier_uniform(self.linear_a2.weight, gain=nn.init.calculate_gain('leak_relu')) # 均匀分布
        nn.init.xavier_uniform(self.linear_a.weight, gain=nn.init.calculate_gain('leak_relu')) # 均匀分布
